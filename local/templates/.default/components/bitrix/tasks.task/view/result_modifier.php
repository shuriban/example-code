...
/*
 * Добывил подсчет количества коммитов
 */
if (Bitrix\Main\Loader::includeModule('firstbit.gitlog'))
{
	$obGitLog = new \FirstBit\GitLog\Main();
	$arResult["DATA"]["TASK"]['GITLOG_COUNT'] = $obGitLog->getCountCommitOnTask($taskData["ID"]);
