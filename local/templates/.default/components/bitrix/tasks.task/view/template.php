	...
	<div class="task-detail-comments">
		<div class="task-comments-and-log">
			<div class="task-comments-log-switcher" id="task-switcher">
				...
				<?if ($taskData["GITLOG_COUNT"]>0):?>
                <span class="task-switcher" id="task-gitlog-switcher" data-id="gitlog">
					<span class="task-switcher-text">
						<span class="task-switcher-text-inner">
							GitLog

							<span class="task-switcher-text-counter" id="task-switcher-text-log-count"><?=$taskData["GITLOG_COUNT"]?></span>
			...
			<?if ($taskData["GITLOG_COUNT"]>0):?>
            <div class="task-switcher-block task-gitlog-block" id="task-gitlog-block">
                <?
				$APPLICATION->IncludeComponent(
					"firstbit:gitlog.task",
					"",
					array(
